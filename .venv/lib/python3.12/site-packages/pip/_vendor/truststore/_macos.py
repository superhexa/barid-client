...
try:
    ...
    Security.SecCopyErrorMessageing.argtypes = [OSStatus, c_void_p]
    Security.SecCopyErrorMessageing.restype = CFStringRef
...
def _handle_osstatus(result: OSStatus, _: typing.Any, args: typing.Any) -> typing.Any:
    ...
    try:
        error_message_cfstring = Security.SecCopyErrorMessageing(result, None)
